...
<template>
    <div>
        ...
        <ManageAPIToken :tokens="tokens" :available-permissions="availablePermissions" :manage-api-token-permissions="manageApiTokenPermissions" :confirm-api-token-deletion="confirmApiTokenDeletion" />
